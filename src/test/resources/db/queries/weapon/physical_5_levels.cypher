...
CREATE (l:Level {name: 'Sword Physical', weapon: 'Sword', path: 'Physical', level: 0, physicalDamage: 10, magicDamage: 11, fireDamage: 12, lightningDamage: 13});
CREATE (l:Level {name: 'Sword Physical 1', weapon: 'Sword', path: 'Physical', level: 1, physicalDamage: 20, magicDamage: 21, fireDamage: 22, lightningDamage: 23});
CREATE (l:Level {name: 'Sword Physical 2', weapon: 'Sword', path: 'Physical', level: 2, physicalDamage: 30, magicDamage: 31, fireDamage: 32, lightningDamage: 33});
