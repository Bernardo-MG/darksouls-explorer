...
CREATE (l:Level {name: 'Sword Physical', target: 'Sword', path: 'Physical', level: 0, physicalDamage: 10, magicDamage: 11, fireDamage: 12, lightningDamage: 13, strengthBonus: 'A', dexterityBonus: 'B', intelligenceBonus: 'C', faithBonus: 'D', physicalReduction: 0, magicReduction: 0, fireReduction: 0, lightningReduction: 0});
