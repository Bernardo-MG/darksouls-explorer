...
@ContextConfiguration(
        initializers = { ITItemServiceGetSources.Initializer.class })
@DisplayName("Reading item sources")
public class ITItemServiceGetSources {
     ...
     * Default constructor.
     */
    public ITItemServiceGetSources() {
        super();
    }
    ...
    public void testGetSources_Count() {
        ...
        data = service.getSources(id, new DisabledPagination(),
            new DisabledSort());
    ...
    public void testGetSources_Data() {
        ...
        data = service
            .getSources(id, new DisabledPagination(), new DisabledSort())
            .iterator()
            .next();
