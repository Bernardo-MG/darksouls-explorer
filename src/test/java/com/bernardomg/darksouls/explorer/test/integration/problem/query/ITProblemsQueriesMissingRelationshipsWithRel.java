...
@IntegrationTest
@ContextConfiguration(initializers = { ITProblemsQueriesMissingRelationshipsWithRel.Initializer.class })
...
public class ITProblemsQueriesMissingRelationshipsWithRel {
    ...
    private static void prepareTestdata() {
        new Neo4jDatabaseInitalizer().initialize("neo4j", dbContainer.getAdminPassword(), dbContainer.getBoltUrl(),
            Arrays.asList("classpath:db/queries/item/with_merchant_source.cypher"));
    }
