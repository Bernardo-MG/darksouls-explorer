...
@IntegrationTest
@DisplayName("Reading all the key items paginated")
@Sql({ "/db/queries/keyitem/multiple.sql" })
public class ITKeyItemServiceGetAllPaged {
     ...
     * Default constructor.
     */
    public ITKeyItemServiceGetAllPaged() {
        super();
    }
