...
@IntegrationTest
@DisplayName("Reading weapon level adjustments with no levels")
@Sql({ "/db/queries/weapon/single.sql" })
public class ITDefaultWeaponServiceGetAdjustmentsNoLevels {
     ...
     * Default constructor.
     */
    public ITDefaultWeaponServiceGetAdjustmentsNoLevels() {
        super();
    }
