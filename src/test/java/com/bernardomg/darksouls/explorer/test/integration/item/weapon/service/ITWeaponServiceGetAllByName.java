...
@ContextConfiguration(
        initializers = { ITWeaponServiceGetAllByName.Initializer.class })
@DisplayName("Reading all the weapons by name")
public class ITWeaponServiceGetAllByName {
     ...
     * Default constructor.
     */
    public ITWeaponServiceGetAllByName() {
        super();
    }
