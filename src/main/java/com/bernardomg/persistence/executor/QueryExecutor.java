...
public interface QueryExecutor {
    ...
    public <T> Collection<T> fetch(final Function<Map<String, Object>, String> queryGenerator,
            final Function<Map<String, Object>, T> mapper);

    public <T> Collection<T> fetch(final Function<Map<String, Object>, String> queryGenerator,
            final Function<Map<String, Object>, T> mapper, final Map<String, Object> parameters);

    public <T> PageIterable<T> fetch(final Function<Map<String, Object>, String> queryGenerator,
            final Function<Map<String, Object>, T> mapper, final Map<String, Object> parameters,
    ...
    public <T> Optional<T> fetchOne(final Function<Map<String, Object>, String> queryGenerator,
            final Function<Map<String, Object>, T> mapper);
