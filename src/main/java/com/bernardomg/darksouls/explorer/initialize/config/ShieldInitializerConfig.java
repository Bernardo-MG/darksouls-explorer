...
@Configuration
@ConditionalOnProperty(prefix = "initialize.db.source", name = "shield",
        havingValue = "true")
public class ShieldInitializerConfig {
    ...
    public ItemReader<ShieldBatchData>
            getShieldItemReader(final LineMapper<ShieldBatchData> lineMapper) {
        return new FlatFileItemReaderBuilder<ShieldBatchData>()
    ...
    public Job getShieldLoaderJob(
            @Qualifier("shieldLoaderStep") final Step armorLoaderStep) {
