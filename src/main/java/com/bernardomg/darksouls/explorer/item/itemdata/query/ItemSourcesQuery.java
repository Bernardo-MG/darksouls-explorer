...
import com.bernardomg.darksouls.explorer.item.itemdata.domain.ImmutableItemMerchantSource;
import com.bernardomg.darksouls.explorer.item.itemdata.domain.ImmutableItemSource;
import com.bernardomg.darksouls.explorer.item.itemdata.domain.ItemSource;
import com.bernardomg.darksouls.explorer.persistence.model.Query;

public final class ItemSourcesQuery implements Query<ItemSource> {
